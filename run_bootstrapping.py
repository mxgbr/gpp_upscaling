# This file performs a Bootstrap for the models, parameters, and variables specified in the provided parameter file.
# The bootstrap has GPP_NT_CUT_REF as target variable
# The bootstrap can be repeated with SLURM array jobs
#
...
from modules.training import Bootstrap
...
if __name__ == "__main__":
    ...
    bootstrap = Bootstrap(model,
                          size=params['bootstrap_size'], 
                          n_folds_tuning=params['n_folds_tuning'], 
                          random_state=params['random_state'])

    runs, X, y = bootstrap.run(data_sel, y_var, strat)
